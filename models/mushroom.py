...
class Mushroom:
    ...
    def write_to_csv(mushrooms):
        ...
        with open(filename, "w", newline='', encoding="utf-8") as file:
            ...
            csvwriter.writerow(["Name", "Common Name", "Family", "Dimensions", "Edibility", "Description", "Image"])

            for mushroom in mushrooms:
                csvwriter.writerow([mushroom.name, mushroom.common_name, mushroom.family, mushroom.dimensions, mushroom.edibility, mushroom.description.replace("\n", "").replace("\r", ""), mushroom.image_urls])
